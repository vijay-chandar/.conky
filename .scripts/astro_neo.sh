...
echo "\${image ~/.conky/Miladriel/images/astro/signs/$Sign.png -p 50,110 -s 100x100}\${image ~/.conky/Miladriel/images/astro/stars/$Sign.png -p 130,115 -s 100x100}\${voffset 60}\${alignc}$BeginDate | $Sign | $EndDate"
